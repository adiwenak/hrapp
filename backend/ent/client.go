...
import (
	...
	"github.com/adiwenak/hrapp/ent/migrate"
...
// QueryOrganisation queries the organisation edge of a User.
func (c *UserClient) QueryOrganisation(u *User) *OrganisationQuery {
